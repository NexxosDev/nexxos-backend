...
const vendor_requests_controller_1 = require("./vendor-requests.controller");
...
exports.RequestsModule = RequestsModule = __decorate([
    (0, common_1.Module)({
        imports: [plans_module_1.PlansModule, client_points_module_1.ClientPointsModule],
        controllers: [requests_controller_1.RequestsController, requests_controller_1.RequestsCronController, vendor_requests_controller_1.VendorRequestsController],
