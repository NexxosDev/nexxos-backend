...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Expo Push Token', example: 'ExponentPushToken[xxxxxxxxxxxxxxxxxxxxxx]' }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], RegisterTokenDto.prototype, "token", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Device platform', enum: ['android', 'ios'] }),
    (0, class_validator_1.IsNotEmpty)(),
