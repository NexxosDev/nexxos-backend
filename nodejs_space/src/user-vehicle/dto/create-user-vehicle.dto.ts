...
export class CreateUserVehicleDto {
  @ApiProperty({ description: 'ID de la marca (catálogo VehicleBrand)' })
  @IsUUID()
  vehicleBrandId!: string;

  @ApiProperty({ description: 'ID del modelo (catálogo VehicleModel)' })
  @IsUUID()
  ...
  @ApiPropertyOptional({ description: 'Apodo opcional (ej. "El carro de mamá")' })
  @IsOptional()
  @IsString()
  @MaxLength(40)
  nickname?: string;
